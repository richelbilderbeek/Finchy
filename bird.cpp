...
void Bird::Land(float timeStep)
{
    ...
    velocity_ += 7.0f * timeStep * targetDelta.Normalized() * Clamp( targetDelta.Length()*0.5f, 2.0f, 4.0f ) - Finchy::Scale(velocity_, Vector3(0.023f, 0.1f, 0.023f));
